...
function App() {
  ...
  const handleCropComplete = useCallback((croppedImageSrc: string, cropData: CropArea) => {
    setCroppedImage({
      src: croppedImageSrc,
      cropData,
    })
  ...
  const handleCanvasPreset = useCallback((preset: { width: number; height: number }) => {
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f8f9fa", padding: "20px" }}>
      <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          <h1 style={{ fontSize: "36px", fontWeight: "bold", color: "#212529", marginBottom: "8px" }}>
            📱 React Image Editor
          </h1>
          <p style={{ fontSize: "18px", color: "#6c757d" }}>
            Nahrajte obrázok, upravte ho a pridajte stickers, text, mentions a lokácie
          </p>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "350px 1fr", gap: "24px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <Card>
              <CardHeader>
                <CardTitle style={{ fontSize: "18px" }}>📁 1. Nahrať obrázok</CardTitle>
              </CardHeader>
              <CardContent>
                <ImageUpload onImageSelect={handleImageSelect} />
                {originalImage && (
                  <div style={{ marginTop: "12px", fontSize: "14px", color: "#6c757d", textAlign: "center" }}>
            ...
            <Card>
              <CardHeader>
                <CardTitle style={{ fontSize: "18px" }}>📐 Veľkosť plátna</CardTitle>
              </CardHeader>
              <CardContent style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                <div>
                  ...
                  <Slider
                    ...
                    onChange={(value) => setCanvasSize((prev) => ({ ...prev, width: value }))}
                    min={200}
                    max={800}
                    step={10}
                  />
                ...
                <div>
                  ...
                  <Slider
                    ...
                    onChange={(value) => setCanvasSize((prev) => ({ ...prev, height: value }))}
                    min={200}
                    max={800}
                    step={10}
                  />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            {originalImage && (
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle style={{ fontSize: "18px" }}>👁️ Preview</CardTitle>
                  </CardHeader>
                  <CardContent
